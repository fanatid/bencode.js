...
test('should be able to decode an integer', function (t) {
  t.true(bencode.decode(new Buffer('i123e')).eqn(123))
  t.true(bencode.decode(new Buffer('i-123e')).eqn(-123))
  t.end()
})
...
test('should be able to decode stuff in dicts (issue #12)', function (t) {
  var expected = {
    ...
    integer: new BN(12345),
    list: [ new BN(1), new BN(3), new Buffer('string', 'ascii'), new BN(5), {} ],
